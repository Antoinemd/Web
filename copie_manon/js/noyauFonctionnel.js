...
*/
	...
	function processData(response){
		...
		console.log("patients affectés: ", cabinetJS.patientsAffectes);

		// remplissage du tableau des patients pour chaque infirmier
		//console.log("liste d'infirmiers: ", cabinetJS.infirmiers['001']);
		console.log("patients sans infirmier:", cabinetJS.patientsNonAffectes);
		console.log("liste des infirmiers:", cabinetJS.infirmiers);
		console.log("cabinetJS:", cabinetJS);
